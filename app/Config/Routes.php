...
$routes->post('transaksi/transaksiedit/(:any)', 'Home::transaksiedit/$1', ['filter' => 'auth']);

$routes->get('transaksi/downloadTransactions', 'TransaksiController::downloadTransactions', ['filter' => 'auth']);
